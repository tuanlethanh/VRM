                            ...
                            if (columnVal.FieldValue != null)
                            {
                                switch (columnVal.ValueType)
                                {
                                    ...
                                    case ValueDataType.Boolean:
                                        Write2ExcelCellString(aWorkbook, col, styleFlag, columnVal.FieldValue == null ? "" : columnVal.FieldValue.ToString(), TextAlignmentType.Right, sheetIndex);
                                        break;
                                    case ValueDataType.String:
                                        Write2ExcelCellString(aWorkbook, col, styleFlag, columnVal.FieldValue == null ? "" : columnVal.FieldValue.ToString(), TextAlignmentType.Left, sheetIndex);
                                        break;
                                }
                            }
                            else
